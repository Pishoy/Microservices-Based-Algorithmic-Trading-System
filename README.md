...
-  to scale the workers to be 2 workers run
...
11. we assume that you bind your server ip address as below is /etc/hosts

```
35.239.58.44 jupyter.example.com
35.239.58.44 airflow.example.com
35.239.58.44 mlflow.example.com
35.239.58.44 pgadmin.example.com
35.239.58.44 superset.example.com
35.239.58.44 minio.example.com
35.239.58.44 flower.example.com

```
12. airflow authentication has been enabled to http://airflow.example.com
 - to create your admin access do below steps:
...
```
 ...
 - now you can login with http://airflow.example.com 
 
    username : admin    
    password : admin

13. flower has been added to celery to login to it use it use http://flower.example.com/
...
## References 
* [Airflow authentication](https://medium.com/@saianupkumarp/apache-airflow-using-docker-along-with-the-authentication-caa3522111c4)
* [airflow celery](https://github.com/puckel/docker-airflow)
* [airflow config](https://airflow.readthedocs.io/en/latest/howto/set-config.html#setting-configuration-options)
